...
`docker run --rm --network host --name otel -p 147.28.187.147:4317:4317 -p 147.28.187.147:8888:8888 -v $(pwd)/config.yaml:/etc/otelcol-contrib/config.yaml otel/opentelemetry-collector-contrib:0.78.0`
