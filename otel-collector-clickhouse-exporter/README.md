...
`docker run --network host --name otel -p 147.28.196.114:4317:4317 -p 147.28.196.114:8888:8888 -v $(pwd)/config.yaml:/etc/otelcol-contrib/config.yaml otel/opentelemetry-collector-contrib:0.78.0`
