...
`docker run --rm --network host --name otel -p 139.178.86.245:4317:4317 -p 139.178.86.245:8888:8888 -v $(pwd)/config.yaml:/etc/otelcol-contrib/config.yaml otel/opentelemetry-collector-contrib:0.78.0`
